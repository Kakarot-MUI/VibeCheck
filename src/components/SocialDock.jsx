...
const getIcon = (platform) => {
  const icons = {
    ...
    discord: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12c.5 1 2 2 4 2s3.5-1 4-2"/><path d="M9 10h.01"/><path d="M15 10h.01"/></svg>
    ),
    steam: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m14 12-4-2.5V11a2 2 0 1 0 2 2v-.5l2-.5Z"/><path d="M10 13a2 2 0 1 1-2-2"/></svg>
    ),
    twitter: (
    ...
    <GlassCard className="social-dock" style={{ borderRadius: '32px', padding: '1.2rem 2rem' }}>
      ...
      <div className="dock-icons">
        {links && links.map(link => (
          <a key={link.id} href={link.url} className="dock-icon-link" target="_blank" rel="noopener noreferrer" title={link.title}>
